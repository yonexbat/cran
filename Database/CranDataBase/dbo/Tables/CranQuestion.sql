CREATE TABLE [dbo].[CranQuestion] (
    ...
    CONSTRAINT [FK_CranQuestion_Question] FOREIGN KEY ([IdQuestionSucessor]) REFERENCES [CranQuestion]([Id])
);
...
CREATE INDEX [IX_CranQuestion_IdQuestionSucessor] ON [dbo].[CranQuestion] ([IdQuestionSucessor])
