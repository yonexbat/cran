...
CREATE INDEX [IX_CranRelQuestionTag_IdQuestion] ON [dbo].[CranRelQuestionTag] ([IdQuestion])

GO

CREATE INDEX [IX_CranRelQuestionTag_IdTag] ON [dbo].[CranRelQuestionTag] ([IdTag])
