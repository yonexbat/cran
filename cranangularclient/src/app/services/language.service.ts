...
export class LanguageService {
  ...
  private map: { [key: string]: LabelTuple; } = {
    ...
    optionrequired : {valueDe : 'Option it ein Mussfeld', valueEn : 'Optiontext is required'},
    ...
    explanationrequired : {valueDe : 'Erklärung ist ein Mussfeld', valueEn : 'Explanation is required'},
    ...
    resultatuebersicht: {valueDe : 'Resultat Übersicht Fragen', valueEn : 'Result overview questions'},
  };
